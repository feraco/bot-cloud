...
import { isLocalAuthEnabled, LOCAL_AUTH_EMAIL, LOCAL_AUTH_PASSWORD } from '@/utils/local-auth';
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center p-4 pb-40 lg:pb-48">
        ...
        <div className="w-full max-w-md animate-fadeIn">
          <div className="rounded-3xl bg-white/80 dark:bg-botbot-dark/80 backdrop-blur-lg shadow-2xl p-8 sm:p-10 border border-white/20 dark:border-botbot-purple/20">
            ...
            {mode === 'login' && isLocalAuthEnabled() && (
              <div className="mt-4 mb-2 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-900 dark:border-emerald-900/50 dark:bg-emerald-950/30 dark:text-emerald-100">
                <div className="font-semibold">Local dev login</div>
                <div>{LOCAL_AUTH_EMAIL}</div>
                <div>{LOCAL_AUTH_PASSWORD}</div>
              </div>
            )}
